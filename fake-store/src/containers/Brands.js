...
export default function Brands() {
    ...
    return (
        <ul style={{ listStyleType: "none",marginTop:'15rem', marginLeft:'15rem',marginRight:'15rem',display:'flex',justifyContent:'space-around'}}>
            {brands.map(element => {
                return <li style={{ display: "flex", marginTop:'4rem',justifyContent:'space-around' }}><img src={element} style={{ maxHeight:"10rem", maxWidth: "15rem"}}/></li>
            })}
        </ul>
    )
}
